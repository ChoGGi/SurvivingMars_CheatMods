...
function OnMsg.ClassesPostprocess()
	...
	xtemplate[#xtemplate+1] = PlaceObj("XTemplateTemplate", {
		...
		"OnContextUpdate", function(self, context)
			if context.producers.Metals
				and context.producers.Metals.ChoGGi_ChoOrig_Produce
			then
	...
	xtemplate[#xtemplate+1] = PlaceObj("XTemplateTemplate", {
		...
		"OnContextUpdate", function(self, context)
			if context.producers.PreciousMetals
				and context.producers.PreciousMetals.ChoGGi_ChoOrig_Produce
			then

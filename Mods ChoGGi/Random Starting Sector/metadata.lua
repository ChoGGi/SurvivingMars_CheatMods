...
Mod Options:
Minimum Surface Deposits: Use a sector with at least this many surface deposits (concrete and scattered metals).
Minimum Subsurface Deposits: Use a sector with at least this many subsurface deposits (metals/rare metals deposits).
If no sector has enough than return the one with the most (sorts by surface than subsurface).
Set both to 0 for actual random (default).

...
return {
	PlaceObj("ModItemOptionNumber", {
		...
		"Help", T(0000, "The chance to hit a meteor."),
	...
	PlaceObj("ModItemOptionNumber", {
		...
		"Help", T(0000, "Cooldown between shots in ms."),
	...
	PlaceObj("ModItemOptionNumber", {
		...
		"Help", T(0000, "If meteors would fall within dist range it can be destroyed by the laser (in hexes)."),
	...
	PlaceObj("ModItemOptionNumber", {
		...
		"Help", T(0000, "Range at which meteors can be destroyed. Should be greater than the protection range (in hexes)."),
	...
	PlaceObj("ModItemOptionNumber", {
		...
		"Help", T(0000, "Platform's rotation speed to target meteor in Deg/Sec."),
	...
	PlaceObj("ModItemOptionNumber", {
		...
		"Help", T(0000, "For how long laser beam is visible (in ms)."),

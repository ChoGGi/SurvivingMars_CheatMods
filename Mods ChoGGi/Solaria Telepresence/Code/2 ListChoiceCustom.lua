...
function SolariaTelepresence_ListChoiceCustomDialog:Init()
  ...
  SolariaTelepresence.ComFuncs.DialogAddCloseX(self)
  SolariaTelepresence.ComFuncs.DialogAddCaption(self,{
    pos = point(25, border),
  ...
  self.idOK:SetSize(SolariaTelepresence.ComFuncs.RetButtonTextSize(title))
  ...
  self.idClose:SetSize(SolariaTelepresence.ComFuncs.RetButtonTextSize(title))
  ...
  local title_size = SolariaTelepresence.ComFuncs.RetCheckTextSize(title)
  ...
  title = T(891--[[Air--]])
  title_size = SolariaTelepresence.ComFuncs.RetCheckTextSize(title)
  ...
  self.idColorCheckWater:SetSize(SolariaTelepresence.ComFuncs.RetCheckTextSize(title))
...
function SolariaTelepresence_ListChoiceCustomDialog:BuildAndApplyLightmodel()
...
--update colour
function SolariaTelepresence_ListChoiceCustomDialog:UpdateColourPicker()
--~   pcall(function()
...
function SolariaTelepresence_ListChoiceCustomDialog:GetAllItems()
...
function SolariaTelepresence_ListChoiceCustomDialog:OnKbdKeyDown(_, virtual_key)
  local const = const

function OnMsg.ClassesBuilt()
  ...
  ChoGGiX.ComFuncs.SaveOrigFunc("ConstructionController","UpdateConstructionStatuses")
  function ConstructionController:UpdateConstructionStatuses(dont_finalize)
    local ChoGGiX = ChoGGiX
    if ChoGGiX.UserSettings.RemoveBuildingLimits then
      --send "dont_finalize" so it comes back here without doing FinalizeStatusGathering
      ChoGGiX.OrigFuncs.ConstructionController_UpdateConstructionStatuses(self,"dont_finalize")
      ...
      return ChoGGiX.OrigFuncs.ConstructionController_UpdateConstructionStatuses(self,dont_finalize)
    end
  end

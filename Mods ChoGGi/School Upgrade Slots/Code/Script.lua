...
function OnMsg.ClassesBuilt()
	local p = BuildingTemplates.School

	p.upgrade1_id = "School_max_visitors1"
	...
	p.upgrade2_id = "School_max_visitors2"
	...
	p.upgrade3_id = "School_max_visitors3"
...
local function StartupCode()
	UICity.unlocked_upgrades.School_max_visitors1 = true
end
...
function OnMsg.BuildingUpgraded(_, id)
	if id == "School_max_visitors1" then
		UICity.unlocked_upgrades.School_max_visitors2 = true
	elseif id == "School_max_visitors2" then
		UICity.unlocked_upgrades.School_max_visitors3 = true
	end
end

...
endlocal T,PlayFX,IsKindOf,XTemplates = T,PlayFX,IsKindOf,XTemplates
local RebuildInfopanel,IsMassUIModifierPressed = RebuildInfopanel,IsMassUIModifierPressed
...
local RemoveXTemplateSections = function(list,name)
...
function OnMsg.ClassesBuilt()
  ...
  --restore the button
	RemoveXTemplateSections(XTemplates.ipBuilding[1][1],"ChoGGi_RestoreMaintenance")

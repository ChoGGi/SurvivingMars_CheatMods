local mod = Mods.ChoGGi_Logos_InitechOfficeSpace

local loadlogos = {
	{
		name = "InitechOfficeSpace1",
		display_name = [[Initech (Office Space)]],
	},
	{
		name = "InitechOfficeSpace2",
		display_name = [[Initech (alt)]],
	},
}

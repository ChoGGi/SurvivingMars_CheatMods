...
--ex(ChangeObjectColour.ListChoiceCustomDialog_Dlg)
--ChangeObjectColour.ListChoiceCustomDialog_Dlg.colorpicker

-- 1 above console log, 1000 above examine
local zorder = 2001001

DefineClass.ChangeObjectColour_ListChoiceCustomDialog = {
...
function ChangeObjectColour_ListChoiceCustomDialog:Init()
  ...
  ChangeObjectColour.ComFuncs.DialogAddCloseX(self)
  ChangeObjectColour.ComFuncs.DialogAddCaption(self,{
    pos = point(25, border),
    ...
    if children[i].class == "Button" then
      ...
      function but.OnButtonPressed()
        ...
        if self.CustomType == 5 then
          ChangeObjectColour.MenuFuncs.ChangeLightmodel(true)
        end
      end
    end
  end
  ...
  function self.idList.OnLButtonDoubleClick()
    ...
    if self.CustomType == 1 then
      ChangeObjectColour.CodeFuncs.ChangeObjectColour(self.sel.obj,self.sel.parentobj)
    elseif self.CustomType == 7 then
      --open it in monitor list
      ChangeObjectColour.CodeFuncs.DisplayMonitorList(self.sel.value,self.sel.parentobj)
  ...
  function self.idEditValue.OnValueChanged()
    local value = ChangeObjectColour.ComFuncs.RetProperType(self.idEditValue:GetValue())
  ...
  self.idOK:SetSize(ChangeObjectColour.ComFuncs.RetButtonTextSize(title))
  ...
  self.idClose:SetSize(ChangeObjectColour.ComFuncs.RetButtonTextSize(title))
  ...
  function self.idColorHSV.OnRButtonDoubleClick()
    if self.CustomType == 2 then
      ...
      ChangeObjectColour.CodeFuncs.SaveOldPalette(self.obj)
      for i = 1, 4 do
  ...
  local title_size = ChangeObjectColour.ComFuncs.RetCheckTextSize(title)
  ...
  title = T(891--[[Air--]])
  title_size = ChangeObjectColour.ComFuncs.RetCheckTextSize(title)
  ...
  self.idColorCheckWater:SetSize(ChangeObjectColour.ComFuncs.RetCheckTextSize(title))
...
function ChangeObjectColour_ListChoiceCustomDialog:BuildAndApplyLightmodel()
  ...
  --rebuild it
  ChangeObjectColour.CodeFuncs.LightmodelBuild(model_table)
  --and temp apply
  SetLightmodel(1,"ChangeObjectColour_Custom")
end

--update colour
function ChangeObjectColour_ListChoiceCustomDialog:UpdateColourPicker()
--~   pcall(function()
    local num = ChangeObjectColour.ComFuncs.RetProperType(self.idEditValue:GetText())
...
function ChangeObjectColour_ListChoiceCustomDialog:GetAllItems()
  ...
  if #items > 0 then
    for i = 1, #items do
      if i == 1 then
        ...
        items[i].editvalue = ChangeObjectColour.ComFuncs.RetProperType(self.idEditValue:GetText())
      end
...
--function ChangeObjectColour_ListChoiceCustomDialog:OnKbdKeyDown(char, virtual_key)
function ChangeObjectColour_ListChoiceCustomDialog:OnKbdKeyDown(_, virtual_key)
  local const = const

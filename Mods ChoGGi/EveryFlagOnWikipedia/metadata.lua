return PlaceObj("ModDef", {
	"title", "Every Flag On Wikipedia v0.2",
	"version", 2,
	"saved", 1534507200,
...
I also added a few unique names associated with space (suggestions welcome, see Code/Flags.lua).
^ New game needed to see them.

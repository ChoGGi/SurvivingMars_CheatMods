...
Msg.NewGame { 0 }
Msg.PreSwitchMap { 2 }
Msg.PostPreSwitchMap { 2 }
Buildable grid ready: 1/1 valid zones.
Msg.PreNewMap { 1 }
Msg.LightmodelNightChange { 3 }
Msg.LightmodelChange { 3 }
Msg.AfterLightmodelChange { 3 }
Msg.NewMap { 0 }
Msg.PostNewMap { 1 }
Msg.NewMapLoaded { 1 }
...
Map changed to "PreGame" in 6727 ms.
Msg.GameStateChanged { 1 }
Msg.LightmodelNightChange { 4 }
Msg.LightmodelChange { 4 }
Msg.AfterLightmodelChange { 4 }
...
Msg.GameStateChanged { 1 }
Msg.GameStateChangedNotify { 0 }
Changing map to "BlankBigCanyonCMix_07"
Msg.ChangeMap { 1 }
Msg.GameStateChanged { 1 }
Msg.LightmodelNightChange { 4 }
Msg.LightmodelChange { 4 }
...
Msg.OnRealmLoad { 1 }
Msg.PreNewGame { 0 }
Msg.FundingChanged { 3 }
Msg.NewGame { 0 }
Msg.PreSwitchMap { 2 }
Msg.ConstValueChanged { 3 }
Msg.RivalsSpawned { 0 }
Msg.OurColonyPlaced { 0 }
Msg.UIModeChange { 1 }
Msg.InGameInterfaceCreated { 1 }
<color 200 200 200> ECM </color>: Startup ticks : 1760
Msg.CityStart { 1 }
Msg.PostPreSwitchMap { 2 }
Buildable grid ready: 6/534 valid zones.
Msg.PreNewMap { 1 }
Msg.GameStateChanged { 1 }
Msg.LightmodelNightChange { 3 }
Msg.LightmodelChange { 3 }
...
Msg.PostNewMap { 1 }
Msg.GameStateChangedNotify { 0 }
Msg.CameraTransitionEnd { 0 }
Msg.UIModeChange { 1 }
Msg.CommandCenterClosed { 0 }
Msg.MessageBoxPreOpen { 0 }
Msg.PopupNotificationBegin { 0 }
Msg.MessageBoxOpened { 0 }
Buildable grid ready: 8/830 valid zones.
[RM] Default preset Polymers_VeryLow selected for Polymers
Msg.AnomalyRevealed { 1 }
starting sector selected: F3
Msg.MapSectorsReady { 1 }
Msg.WaterPhysicalStateChange { 1 }
Msg.NewMapLoaded { 1 }
Msg.GameStateChanged { 1 }
Msg.LightmodelNightChange { 4 }
Msg.LightmodelChange { 4 }
...
Msg.NewWorkshift { 1 }
Msg.NewHour { 1 }
Msg.UpgradeUnlocked { 2 }
Msg.UpgradeUnlocked { 2 }
Msg.UpgradeUnlocked { 2 }
Msg.UpgradeUnlocked { 2 }
Msg.UpgradeUnlocked { 2 }
Msg.UpgradeUnlocked { 2 }
Msg.SequenceListPlayerStart { 1 }
Msg.SequenceStart { 2 }
game_settings:
    save_game_id: TEjiLzYt6D0A0aKu
    sponsor: IMM
    profile: rocketscientist
    mystery: random
    mystery_random: TheMarsBug
    coordinates: 6S26E
    landing_spot:
    logo: MarsExpress
map_conditions:
...
map_resources:
    ...
    water: 73
Msg.MysteryChosen { 0 }
Msg.BuildingPlaced { 1 }
Msg.BuildingPlaced { 1 }
Msg.BuildingPlaced { 1 }
Msg.BuildingPlaced { 1 }
Msg.BuildingPlaced { 1 }
Msg.AnomalyRevealed { 1 }
Msg.AddToCityLabels { 1 }
Msg.BuildingInit { 1 }
Msg.AddToCityLabels { 1 }
Msg.BuildingInit { 1 }
Msg.AddToCityLabels { 1 }
...
Msg.SequenceStop { 2 }
Msg.ConstValueChanged { 3 }
Msg.TechResearched { 3 }
Msg.TechResearchedTrigger { 1 }
Msg.GameStateChanged { 1 }
Msg.ChangeMapDone { 1 }
Msg.ResumeInviteChecks { 0 }
Map changed to "BlankBigCanyonCMix_07" in 9329 ms.
UpdateMaps: old: "{ BlankBigCanyonCMix_07 }" -> new: "{ BlankUnderground_03, BlankBigCanyonCMix_07 }"
Load maps: "{ BlankUnderground_03 }"
Msg.GameStateChangedNotify { 0 }
Msg.OnRealmLoad { 1 }
Switching map
Msg.CameraTransitionStart { 3 }
Msg.CameraTransitionEnd { 0 }
Msg.UIModeChange { 1 }
Msg.PreSwitchMap { 2 }
Msg.PostPreSwitchMap { 2 }
Msg.PostSetMapData { 1 }
Buildable grid ready: 14/114 valid zones.
Msg.PreNewMap { 1 }
Msg.PostNewMap { 1 }
[RM] No border zone
Buildable grid ready: 25/156 valid zones.
Msg.BuildingPlaced { 1 }
Msg.BuildingPlaced { 1 }
Msg.BuildingPlaced { 1 }
Msg.OnPassabilityChanged { 2 }
...
Msg.OnSetWorking { 2 }
Msg.ChangeMapDone { 1 }
UpdateMaps: old: "{ BlankUnderground_03, BlankBigCanyonCMix_07 }" -> new: "{ BlankBigCanyonCMix_07, BlankUnderground_03 }"
Switching map
Msg.CameraTransitionStart { 3 }
Msg.CameraTransitionEnd { 0 }
Msg.UIModeChange { 1 }

...
local str_Fixes = T(302535920000922--[[Fixes--]])
local str_Most = T(302535920000935--[[Most--]])
local str_Toggles = T(302535920000938--[[Toggles--]])

AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[9]",T(302535920000461--[[All Pipe Skins To Default--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[9]",T(302535920000292--[[Reset Rovers--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[9]",T(302535920000055--[[Reset All Colonists--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[9]",T(302535920000581--[[Toggle Collisions On Selected Object--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[9]",T(302535920000583--[[Rebuild Walkable Points In Domes--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[9]",T(302535920000585--[[Colonists Stuck Outside Rocket--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[9]",T(302535920000587--[[Remove Missing Class Objects (Warning)--]])),
...
---------------------------------most
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[0]"," ",T(302535920000589--[[Fire Most Fixes--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[0]",str_Most,"/",T(302535920000591--[[Colonists Trying To Board Rocket Freezes Game--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[0]",str_Most,"/",T(302535920000593--[[Remove Particles With Null Polylines--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[0]",str_Most,"/",T(302535920000595--[[Mirror Sphere Stuck--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[0]",str_Most,"/",T(302535920000597--[[Stutter With High FPS or Human Centipede--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[0]",str_Most,"/",T(302535920000599--[[Drones Keep Trying Blocked Areas--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[0]",str_Most,"/",T(302535920000601--[[Idle Drones Won't Build When Resources Available--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[0]",str_Most,"/",T(302535920000603--[[Remove Yellow Grid Marks--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[0]",str_Most,"/",T(302535920001193--[[Remove Blue Grid Marks--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[0]",str_Most,"/",T(302535920000605--[[Project Morpheus Radar Fell Down--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[0]",str_Most,"/",T(302535920000157--[[Cables & Pipes--]]),": ",T(302535920000607--[[Instant Repair--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[0]",str_Most,"/",T(302535920000609--[[Attach Buildings To Nearest Working Dome--]])),
...
if ChoGGi.Testing then
  AddAction(
    Concat(str_ECM,"/",str_Fixes,"/[6]",str_Toggles,"/",T(302535920001071--[[Drone Charges From Rover Wrong Angle--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[6]",str_Toggles,"/",T(302535920001266--[[Broked Transport Pathing--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[6]",str_Toggles,"/",T(302535920000248--[[Colonists Stuck Outside Service Buildings--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[6]",str_Toggles,"/",T(302535920000613--[[Drone Carry Amount--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[6]",str_Toggles,"/",T(302535920000615--[[Sort Command Center Dist--]])),
...
-----------------------ECM fixes
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[99]",str_ECM2," ",str_Fixes,"/",T(302535920000617--[[See tooltip--]])),
  "blank_function",
  nil,
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[99]",str_ECM2," ",str_Fixes,"/[1]",T(302535920000619--[[Fix Black Cube Colonists--]])),
...
AddAction(
  Concat(str_ECM,"/",str_Fixes,"/[99]",str_ECM2," ",str_Fixes,"/[1]",T(302535920000621--[[Align All Buildings To Hex Grid--]])),

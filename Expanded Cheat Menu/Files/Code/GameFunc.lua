...
function ChoGGi.MenuFuncs.SetLightsRadius()
  local ItemList = {
    ...
    {text = ChoGGi.ComFuncs.Trans(302535920001006,"03 Low (90) < Menu Option"),value = 90},
    {text = ChoGGi.ComFuncs.Trans(302535920001007,"04 Medium (95) < Menu Option"),value = 95},
    {text = ChoGGi.ComFuncs.Trans(302535920001008,"05 High (100) < Menu Option"),value = 100},
...
function ChoGGi.MenuFuncs.SetTerrainDetail()
  ...
  local ItemList = {
    ...
    {text = ChoGGi.ComFuncs.Trans(302535920001004,"01 Lowest (25)"),value = 25},
    {text = ChoGGi.ComFuncs.Trans(302535920001005,"02 Lower (50)"),value = 50},
    {text = ChoGGi.ComFuncs.Trans(302535920001021,"03 Low (100) < Menu Option"),value = 100},
    {text = ChoGGi.ComFuncs.Trans(302535920001022,"04 Medium (150) < Menu Option"),value = 150},
    {text = ChoGGi.ComFuncs.Trans(302535920001008,"05 High (100) < Menu Option"),value = 100},
    {text = ChoGGi.ComFuncs.Trans(302535920001024,"06 Ultra (200) < Menu Option"),value = 200},
    {text = ChoGGi.ComFuncs.Trans(302535920001010,"07 Ultra-er (400)"),value = 400},
    {text = ChoGGi.ComFuncs.Trans(302535920001011,"08 Ultra-er (600)"),value = 600},
...
function ChoGGi.MenuFuncs.SetVideoMemory()
  local ItemList = {
    ...
    {text = ChoGGi.ComFuncs.Trans(302535920001034,"4 Low (256) < Menu Option"),value = 256},
    {text = ChoGGi.ComFuncs.Trans(302535920001035,"5 Medium (512) < Menu Option"),value = 512},
    {text = ChoGGi.ComFuncs.Trans(302535920001036,"6 High (1024) < Menu Option"),value = 1024},
    {text = ChoGGi.ComFuncs.Trans(302535920001037,"7 Ultra (2048) < Menu Option"),value = 2048},
...
function ChoGGi.MenuFuncs.SetShadowmapSize()
  ...
  local ItemList = {
    ...
    {text = ChoGGi.ComFuncs.Trans(302535920001045,"3 Low (1536) < Menu Option"),value = 1536},
    {text = ChoGGi.ComFuncs.Trans(302535920001046,"4 Medium (2048) < Menu Option"),value = 2048},
    {text = ChoGGi.ComFuncs.Trans(302535920001047,"5 High (4096) < Menu Option"),value = 4096},

...
function ChoGGi.ConsoleFuncs.BuildExamineMenu()
	...
	AddSubmenu("UICity", nil, "UICity.tech_status", "g_CurrentMissionParams", "BuildMenuPrerequisiteOverrides", "BuildingTechRequirements", "g_ApplicantPool", "RivalAIs", "TaskRequesters", "LRManagerInstance")

...
--~ print(dsds)
		...
		local str = token('string', singlequoted_string +
																doublequoted_string +
																longstring)
		...
		local any_token = whitespace + number + keyword + ident +
											str + comment + operator + token('error', 1)
		...
		local multiline_tokens = { comment = true, str = true, whitespace = true }

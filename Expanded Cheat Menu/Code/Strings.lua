...
local Strings = {
  ...
  [2] = _InternalTranslate(T{2}), -- Unlock Tech
  [3] = _InternalTranslate(T{3}), -- Grant Research
  [6] = _InternalTranslate(T{6}), -- Depth Layer
  [7] = _InternalTranslate(T{7}), -- Is Revealed
  [8] = _InternalTranslate(T{8}), -- Breakthrough Tech
  [9] = _InternalTranslate(T{9}), -- Anomaly
  ...
  [25] = _InternalTranslate(T{25}), -- Anomaly Scanning
  ...
  [67] = _InternalTranslate(T{67}), -- Loading resourcesLoading resources
  ...
  [5422] = _InternalTranslate(T{5422}), -- Exploration
  ...
  [5661] = _InternalTranslate(T{5661}), -- Mystery Log
  ...
  [8490] = _InternalTranslate(T{8490}), -- Loading complete
  ...
  [589254325694] = _InternalTranslate(T{589254325694}), -- Goal
  [619281504128] = _InternalTranslate(T{619281504128}), -- Maintenance
  ...
  [987648737170] = _InternalTranslate(T{987648737170}), -- Map
}

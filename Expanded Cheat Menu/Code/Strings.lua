...
local Strings = {
  ...
  [293] = TranslationTable[293], -- Discharged<right><drone(DischargedDronesCount)>
  [294] = TranslationTable[294], -- Broken<right><drone(BrokenDronesCount)>
  [295] = TranslationTable[295], -- Idle<right><drone(IdleDronesCount)>
  [311] = TranslationTable[311], -- Research
  [434] = TranslationTable[434], -- Lifetime<right><lifetime>
  ...
  [4139] = TranslationTable[4139], -- RareMetals
  ...
  [4273] = TranslationTable[4273], -- Saved on <save_date>
  [4274] = TranslationTable[4274], -- Playtime <playtime>
  ...
  [4356] = TranslationTable[4356], -- Sex<right><Gender>
  [4357] = TranslationTable[4357], -- Birthplace<right><UIBirthplace>
  [4439] = TranslationTable[4439], -- Going to<right><h SelectTarget InfopanelSelect><Target></h>
  ...
  [5647] = TranslationTable[5647], -- Dead Colonists: <count>
  ...
  [6729] = TranslationTable[6729], -- Daily Production <n>
  ...
  [7657] = TranslationTable[7657], -- <ButtonY> Activate
  ...
  [1000012] = TranslationTable[1000012], -- Mod <ModLabel> will be uploaded to Steam
  [1000013] = TranslationTable[1000013], -- Mod <ModLabel> was not uploaded to Steam. Error: <err>
  [1000014] = TranslationTable[1000014], -- Mod <ModLabel> was successfully uploaded to Steam!
  ...
  [1000058] = TranslationTable[1000058], -- Missing file <u(src)> referenced in entity
  ...
  [313911890683] = TranslationTable[313911890683], -- <description>
  ...
  [584248706535] = TranslationTable[584248706535], -- Carrying<right><ResourceAmount>

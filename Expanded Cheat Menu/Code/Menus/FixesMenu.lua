...
function OnMsg.ClassesGenerate()
	...
	c = c + 1
	Actions[c] = {ActionName = Strings[302535920000589--[[Fire Most Fixes--]]],
		ActionMenubar = str_ECM_Fixes,
		ActionId = ".Fire Most Fixes",
		ActionIcon = icon,
		RolloverText = Strings[302535920000590--[[Fires all the fixes in the "Most" menu (nuke 'em from orbit and all that).
	Should be safe to use without breaking anything.--]]],
		OnAction = ChoGGi.MenuFuncs.FireMostFixes,
		ActionSortKey = "-1Fire Most Fixes",
	}

	local str_ECM_Fixes_Most = "ECM.ECM.Fixes.Most"
	c = c + 1
	Actions[c] = {ActionName = Strings[302535920000935--[[Most--]]],
	...
	Actions[c] = {ActionName = Strings[302535920001266--[[Borked Transport Pathing--]]],
		ActionMenubar = str_ECM_Fixes_Toggles,
...
This may break the save in other ways, best to just use it for testing."--]]]
	...
	local str_ECM_Fixes_ECMFixes = "ECM.ECM.Fixes.ECM Fixes"
	c = c + 1
	...
	Actions[c] = {ActionName = Strings[302535920000617--[[See tooltip--]]],
		ActionMenubar = str_ECM_Fixes_ECMFixes,

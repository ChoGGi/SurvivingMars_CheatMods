...
-- menu
c = c + 1
Actions[c] = {ActionName = T(302535920000922--[[Fixes]]),
	ActionMenubar = "ECM.ECM",
	ActionId = ".Fixes",
	ActionIcon = "CommonAssets/UI/Menu/folder.tga",
	OnActionEffect = "popup",
	RolloverText = T(302535920000036--[[Click lightly!
Be sure to read the tooltip and if unsure than ask me.]]),
}

c = c + 1
Actions[c] = {ActionName = T(302535920001351--[[Rocket Crashes Game On Landing]]),
...
c = c + 1
Actions[c] = {ActionName = T(302535920001299--[[Toggle Working On All Buildings]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920001295--[[Drones Not Repairing Domes]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920001084--[[Reset]]) .. " " .. T(5221--[[RC Commanders]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000055--[[Reset All Colonists]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000583--[[Rebuild Walkable Points In Domes]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000585--[[Colonists Stuck Outside Rocket]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000587--[[Remove Missing Class Objects]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000591--[[Colonists Trying To Board Rocket Freezes Game]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000593--[[Remove Particles With Null Polylines]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000595--[[Mirror Sphere Stuck]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000597--[[Stutter With High FPS]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000599--[[Drones Keep Trying Blocked Areas]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000601--[[Idle Drones Won't Build When Resources Available]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000603--[[Remove Yellow Grid Marks]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920001193--[[Remove Blue Grid Marks]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000605--[[Project Morpheus Radar Fell Down]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000157--[[Cables & Pipes]]) .. ": " .. T(302535920000607--[[Instant Repair]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000609--[[Attach Buildings To Nearest Working Dome]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920001533--[[Remove Invalid Label Objects]]),
	ActionMenubar = "ECM.ECM.Fixes",
...
-- menu
c = c + 1
Actions[c] = {ActionName = T(302535920000938--[[Toggles]]),
	ActionMenubar = "ECM.ECM.Fixes",
	ActionId = ".Toggles",
	ActionIcon = "CommonAssets/UI/Menu/folder.tga",
	OnActionEffect = "popup",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000248--[[Colonists Stuck Outside Service Buildings]]),
	...
	RolloverText = function()
		return SettingState(
			...
			T(302535920000249--[["Colonists will leave a diner/etc and stop outside of it and not move anymore (might be related to one of those smarter worker ai mods).
...
c = c + 1
Actions[c] = {ActionName = T(302535920000613--[[Drone Carry Amount]]),
	ActionMenubar = "ECM.ECM.Fixes.Toggles",
	...
	RolloverText = function()
		return SettingState(
			...
			T(302535920000614--[["Drones only pick up resources from buildings when the amount stored is equal or greater then their carry amount.
...
c = c + 1
Actions[c] = {ActionName = T(302535920000615--[[Sort Command Center Dist]]),
	ActionMenubar = "ECM.ECM.Fixes.Toggles",
	...
	RolloverText = function()
		return SettingState(
			...
			T(302535920000616--[["Each Sol goes through all buildings and sorts their cc list by nearest.
...
c = c + 1
Actions[c] = {ActionName = T(302535920001483--[[Missing Mod Buildings]]),
	ActionMenubar = "ECM.ECM.Fixes.Toggles",
	...
	RolloverText = function()
		return SettingState(
			...
			T(302535920001484--[["Removes any placed buildings that were from a mod.
...
-- menu
c = c + 1
Actions[c] = {ActionName = T(302535920000002--[[ECM]]) .. " " .. T(302535920000922--[[Fixes]]),
	ActionMenubar = "ECM.ECM.Fixes",
	ActionId = ".ECM Fixes",
	ActionIcon = "CommonAssets/UI/Menu/folder.tga",
	OnActionEffect = "popup",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000617--[[See tooltip]]),
	ActionMenubar = "ECM.ECM.Fixes.ECM Fixes",
	ActionId = ".See tooltip",
	ActionIcon = "CommonAssets/UI/Menu/help.tga",
	RolloverText = T(302535920000618--[[Fixes for stuff that I messed up, these should all be fine to fire even without the issues, but they shouldn't be needed.]]),
	OnAction = empty_func,
	ActionSortKey = "-1",
}

c = c + 1
Actions[c] = {ActionName = T(302535920000619--[[Fix Black Cube Colonists]]),
	ActionMenubar = "ECM.ECM.Fixes.ECM Fixes",
...
c = c + 1
Actions[c] = {ActionName = T(302535920000621--[[Align All Buildings To Hex Grid]]),
	ActionMenubar = "ECM.ECM.Fixes.ECM Fixes",

	...
	Actions[c] = {ActionName = S[302535920000505--[[Work Radius RC Rover--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000506--[[Change RC Rover drone radius (this ignores slider).--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000507--[[Work Radius DroneHub--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000508--[[Change DroneHub drone radius (this ignores slider).--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000509--[[Drone Rock To Concrete Speed--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000510--[[How long it takes drones to convert rock to concrete.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000511--[[Drone Move Speed--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000512--[[How fast drones will move.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000515--[[DroneFactory Build Speed--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000516--[[Change how fast drone factories build drones.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000517--[[Drone Gravity--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000518--[[Change gravity of Drones.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000521--[[Drone Build Speed--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000522--[[Instant build/repair when resources are ready.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = Translate(4645--[[Drone Recharge Time--]]),
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000526--[[Faster/Slower Drone Recharge.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000527--[[Drone Repair Supply Leak Speed--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000528--[[Faster Drone fix supply leak.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000529--[[Drone Carry Amount--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000530--[[Change amount drones can carry.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000531--[[Drones Per Drone Hub--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000532--[[Change amount of drones Drone Hubs will command.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000533--[[Drones Per RC Rover--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000534--[[Change amount of drones RC Rovers will command.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920001403--[[Drone Type--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920001404--[[Change what type of drones will spawn (doesn't effect existing).--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000535--[[Set ShuttleHub Shuttle Capacity--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000536--[[Change amount of shuttles per shuttlehub.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000537--[[Set Capacity--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000538--[[Change capacity of shuttles.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000539--[[Set Speed--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000540--[[Change speed of shuttles.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000541--[[RC Set Charging Distance--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000542--[[Distance from power lines that rovers can charge.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000543--[[RC Move Speed--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000544--[[How fast RCs will move.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000545--[[RC Gravity--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000546--[[Change gravity of RCs.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000549--[[RC Instant Resource Transfer--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000550--[[Make it instantly gather/transfer resources.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000551--[[RC Storage Capacity--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000552--[[Change amount of resources RC Transports/Constructors can carry.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920001291--[[Max Export Amount--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920001290--[[Change how many rares per rocket you can export.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920001317--[[Launch Fuel Per Rocket--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920001318--[[Change how much fuel rockets need to launch.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920001319--[[Rockets Ignore Fuel--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920001320--[[Rockets don't need fuel to launch.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000559--[[Cargo Capacity--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000560--[[Change amount of storage space in rockets.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = S[302535920000561--[[Travel Time--]]],
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000562--[[Change how long to take to travel between planets.--]]]
			)
		end,
	...
	Actions[c] = {ActionName = Translate(4594--[[Colonists Per Rocket--]]),
		...
		RolloverText = function()
			return ChoGGi.ComFuncs.SettingState(
				...
				S[302535920000564--[[Change how many colonists can arrive on Mars in a single Rocket.--]]]
			)
		end,

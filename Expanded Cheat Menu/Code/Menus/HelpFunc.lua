...
function OnMsg.ClassesGenerate()
	...
	do -- ModUpload
		...
		function ChoGGi.MenuFuncs.ModUpload()
			if blacklist then
				print(string.format(S[302535920000242--[[%s is blocked by SM function blacklist; use ECM HelperMod to bypass or tell the devs that ECM is awesome and it should have Über access.--]]],"ModUpload"))
				return
			end

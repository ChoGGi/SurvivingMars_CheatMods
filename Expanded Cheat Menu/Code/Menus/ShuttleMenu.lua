...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000535--[[Set ShuttleHub Shuttle Capacity]]],
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920000536--[[Change amount of shuttles per shuttlehub.]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000930--[[Set Cargo Shuttle Capacity]]],
	ActionMenubar = "ECM.ECM.Shuttles",
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920000538--[[Change capacity of shuttles.]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000932--[[Set Cargo Shuttle Speed]]],
	ActionMenubar = "ECM.ECM.Shuttles",
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920000540--[[Change speed of shuttles.]]]
		)
	end,

...
do -- BuildGridList
	...
	function ChoGGi.MenuFuncs.BuildGridList()
		...
		grid_list.air.name = T(891--[[Air]])
		grid_list.electricity.name = T(79--[[Power]])
		grid_list.electricity.__HideCables = {
			ChoGGi_AddHyperLink = true,
			name = T(302535920000142--[[Hide]]) .. " " .. T(881--[[Power Cables]]),
			func = function(ex_dlg)
				FilterExamineList(ex_dlg, "ElectricityGridElement")
			end,
		}
		grid_list.water.name = T(681--[[Water]])
		grid_list.water.__HidePipes = {
			ChoGGi_AddHyperLink = true,
			name = T(302535920000142--[[Hide]]) .. " " .. T(882--[[Pipes]]),
			func = function(ex_dlg)
...
--~ 					.. ": " .. T(682--[[Oxygen]])
--~ 					.. "(" .. (table.find(UICity.air, obj.air.grid) or T(6774--[[Error]])) .. ") "
--~ 					.. T(681--[[Water]]) .. "("
...
--~ 			end,
		Deposit = function(obj)
			...
			return "- " .. RetName(obj) .. " -\n" .. T(6--[[Depth Layer]])
				.. ": " .. obj.depth_layer .. ", " .. T(7--[[Is Revealed]])
				.. ": " .. tostring(obj.revealed) .. "\n" .. T(16--[[Grade]]) .. ": "
				.. obj.grade .. ", " .. T(1000100--[[Amount]]) .. ": "
		...
		Drone = function(obj)
			...
			return "- " .. RetName(obj) .. " -\n"
				...
				.. T(3722--[[State]]) .. ": " .. GetStateName(obj:GetState()) .. ", "
				.. "\n" .. T(4448--[[Dust]]) .. ": " .. (obj.dust / r) .. "/" .. (obj.dust_max / r)
		...
		Production = function(obj)
			...
			if waste ~= "" then
				...
				waste = "- " .. T(4518--[[Waste Rock]]) .. " -\n"
				.. T(80--[[Production]]) .. ": " .. prefix .. " " .. predprod .. ", "
		...
		Dome = function(obj)
			...
			local a, e, w = T(682--[[Oxygen]]), T(79--[[Power]]), T(681--[[Water]])
			local city = obj.city or UICity

			local ga = obj.air
			local ge = obj.electricity
			local gw = obj.water
			local ga_id = table.find(city.air, ga.grid) or T(6774--[[Error]])
			local ge_id = table.find(city.electricity, ge.grid) or T(6774--[[Error]])
			local gw_id = table.find(city.water, gw.grid) or T(6774--[[Error]])
			local l = obj.labels

			return "- " .. RetName(obj) .. " -\n"
				.. T(547--[[Colonists]]) .. ": " .. #(l.Colonist or "")
				.. "\n" .. T(6859--[[Unemployed]]) .. ": " .. #(l.Unemployed or "") .. "/" .. Dome_GetWorkingSpace(obj)
				.. ", " .. T(7553--[[Homeless]]) .. ": " .. #(l.Homeless or "") .. "/" .. obj:GetLivingSpace()
				.. "\n" .. T(7031--[[Renegades]]) .. ": " .. #(l.Renegade or "")
				.. ", " .. Translate(5647--[[Dead Colonists: <count>]]):gsub("<count>", #(l.DeadColonist or ""))
				.. "\n" .. T(6647--[[Guru]]) .. ": " .. #(l.Guru or "")
				.. ", " .. T(6640--[[Genius]]) .. ": " .. #(l.Genius or "")
				.. ", " .. T(6642--[[Celebrity]]) .. ": " .. #(l.Celebrity or "")
				.. ", " .. T(6644--[[Saint]]) .. ": " .. #(l.Saint or "")
				...
				.. "\n" .. T(1022--[[Food]]) .. " (" .. #(l.needFood or "") .. "): "
				.. go_to:format(": " .. food_need)
				.. ", " .. T(526--[[Visitors]]) .. ": " .. food_use .. "/" .. food_max
				.. "\n" .. T(3862--[[Medic]]) .. " (" .. #(l.needMedical or "") .. "): "
				.. go_to:format(": " .. medic_need)
				.. ", " .. T(526--[[Visitors]]) .. ": " .. medic_use .. "/" .. medic_max
				.. "\n\n" .. T(302535920000035--[[Grids]]) .. ": "
				.. a .. "(" .. ga_id .. ") "
				.. w .. "(" .. gw_id .. ") "
				.. e .. "(" .. ge_id .. ")"
	...
	function ChoGGi.MenuFuncs.BuildingInfo_Toggle()
		local item_list = {
			{text = T(83--[[Domes]]), value = "Dome"},
			{text = T(3982--[[Deposits]]), value = "Deposit"},
			{text = T(80--[[Production]]), value = "Production"},
			{text = T(517--[[Drones]]), value = "Drone"},
			{text = T(5433--[[Drone Control]]), value = "DroneControl"},
--~ 				{text = T(4290--[[Colonist]]), value = "Colonist"},
--~ 				{text = T(885971788025--[[Outside Buildings]]), value = "OutsideBuildings"},

--~ 			 {text = T(79--[[Power]]), value = "Power"},
--~			 {text = T(81--[[Life Support]]), value = "Life-Support"},
		}
...
function ChoGGi.MenuFuncs.MonitorInfo()
	local item_list = {
		...
		{text = "", value = "New"},
		{text = T(302535920000035--[[Grids]]) .. ": " .. T(891--[[Air]]), value = "Air"},
		{text = T(302535920000035--[[Grids]]) .. ": " .. T(79--[[Power]]), value = "Power"},
		{text = T(302535920000035--[[Grids]]) .. ": " .. T(681--[[Water]]), value = "Water"},
		{text = T(302535920000035--[[Grids]]) .. ": " .. T(891--[[Air]]) .. "/" .. T(79--[[Power]]) .. "/" .. T(681--[[Water]]), value = "Grids"},
	...
	if ChoGGi.testing then
		item_list[#item_list+1] = {text = T(311--[[Research]]), value = "Research"}
	end

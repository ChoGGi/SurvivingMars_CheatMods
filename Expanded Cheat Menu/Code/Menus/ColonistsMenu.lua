...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000369--[[No More Earthsick]]],
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920000370--[[Colonists will never become Earthsick (and removes any when you enable this).]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000371--[[Traits: Restrict For Selected Building Type]]],
	ActionMenubar = "ECM.ECM.Colonists",
	...
	RolloverText = function()
		...
		return obj and SettingState(
			...
			TranslationTable[302535920000372--[[Select a building and use this to only allow workers with certain traits to work there (block will override).]]]
		) or TranslationTable[302535920000372]
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000373--[[Traits: Block For Selected Building Type]]],
	ActionMenubar = "ECM.ECM.Colonists",
	...
	RolloverText = function()
		...
		return obj and SettingState(
			...
			TranslationTable[302535920000374--[[Select a building and use this to block workers with certain traits from working there (overrides restrict).]]]
		) or TranslationTable[302535920000374]
	end,
	OnAction = ChoGGi.MenuFuncs.SetBuildingTraits,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000375--[[The Soylent Option]]],
	ActionMenubar = "ECM.ECM.Colonists",
	ActionId = ".The Soylent Option",
	ActionIcon = "CommonAssets/UI/Menu/Cube.tga",
	RolloverText = TranslationTable[302535920000376--[[Turns selected/moused over colonist into food (between 1-5), or shows a list with choices.]]],
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000377--[[Colonists Move Speed]]],
	ActionMenubar = "ECM.ECM.Colonists",
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920000378--[[How fast colonists will move.]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000379--[[Add Or Remove Applicants]]],
	ActionMenubar = "ECM.ECM.Colonists",
	...
	RolloverText = function()
		return SettingState(
			#(g_ApplicantPool or ""),
			TranslationTable[302535920000380--[[Add random applicants to the passenger pool (has option to remove all).]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000418--[[Colonists Starve]]],
	ActionMenubar = "ECM.ECM.Colonists",
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000424--[[Set Age New]]],
	ActionMenubar = "ECM.ECM.Colonists",
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920000425--[[This will make all newly arrived and born colonists a certain age.]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000426--[[Set Age]]],
	ActionMenubar = "ECM.ECM.Colonists",
	ActionId = ".Set Age",
	ActionIcon = StarkFistOfRemoval,
	RolloverText = TranslationTable[302535920000427--[[This will make all colonists a certain age.]]],
	OnAction = ChoGGi.MenuFuncs.SetColonistsAge,
	setting_mask = 2,
}

c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000428--[[Set Gender New]]],
	ActionMenubar = "ECM.ECM.Colonists",
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920000429--[[This will make all newly arrived and born colonists a certain gender.]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000430--[[Set Gender]]],
	ActionMenubar = "ECM.ECM.Colonists",
	ActionId = ".Set Gender",
	ActionIcon = StarkFistOfRemoval,
	RolloverText = TranslationTable[302535920000431--[[This will make all colonists a certain gender.]]],
	OnAction = ChoGGi.MenuFuncs.SetColonistsGender,
	setting_mask = 2,
}

c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000432--[[Set Specialization New]]],
	ActionMenubar = "ECM.ECM.Colonists",
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920000433--[[This will make all newly arrived colonists a certain specialization (children and spec = black cube).]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000434--[[Set Specialization]]],
	ActionMenubar = "ECM.ECM.Colonists",
	ActionId = ".Set Specialization",
	ActionIcon = StarkFistOfRemoval,
	RolloverText = TranslationTable[302535920000435--[[This will make all colonists a certain specialization.]]],
	OnAction = ChoGGi.MenuFuncs.SetColonistsSpecialization,
	setting_mask = 2,
}

c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000436--[[Set Race New]]],
	ActionMenubar = "ECM.ECM.Colonists",
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920000437--[[This will make all newly arrived and born colonists a certain race.]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000438--[[Set Race]]],
	ActionMenubar = "ECM.ECM.Colonists",
	ActionId = ".Set Race",
	ActionIcon = StarkFistOfRemoval,
	RolloverText = TranslationTable[302535920000439--[[This will make all colonists a certain race.]]],
	OnAction = ChoGGi.MenuFuncs.SetColonistsRace,
	setting_mask = 2,
}

c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000440--[[Set Traits New]]],
	ActionMenubar = "ECM.ECM.Colonists",
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920000441--[[This will make all newly arrived and born colonists have certain traits.]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000442--[[Set Traits]]],
	ActionMenubar = "ECM.ECM.Colonists",
	ActionId = ".Set Traits",
	ActionIcon = StarkFistOfRemoval,
	RolloverText = TranslationTable[302535920000443--[[Choose traits for all colonists.]]],
	OnAction = ChoGGi.MenuFuncs.SetColonistsTraits,
	setting_mask = 2,
}

c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000836--[[Set Stats Of All Colonists]]],
	ActionMenubar = "ECM.ECM.Colonists",
	ActionId = ".Set Stats Of All Colonists",
	ActionIcon = StarkFistOfRemoval,
	RolloverText = TranslationTable[302535920000445--[["Change the stats of all colonists (health/sanity/comfort/morale).
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000446--[[Colonist Death Age]]],
	ActionMenubar = "ECM.ECM.Colonists",
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920000447--[[Change the age at which colonists die (applies to newly arrived and born colonists as well).]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000383--[[Fire All Colonists!]]],
	ActionMenubar = "ECM.ECM.Colonists.Workplaces",
	ActionId = ".Fire All Colonists!",
	ActionIcon = "CommonAssets/UI/Menu/ToggleEnvMap.tga",
	RolloverText = TranslationTable[302535920000384--[[Fires everyone from every job.]]],
	OnAction = ChoGGi.MenuFuncs.FireAllColonists,
}

c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000385--[[Set All Work Shifts]]],
	ActionMenubar = "ECM.ECM.Colonists.Workplaces",
	ActionId = ".Set All Work Shifts",
	ActionIcon = "CommonAssets/UI/Menu/ToggleEnvMap.tga",
	RolloverText = TranslationTable[302535920000386--[[Set all shifts on or off (able to cancel).]]],
...
Actions[c] = {ActionName = TranslationTable[4572--[[Outside Workplace Sanity Penalty]]],
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920001590--[["Remove the ""Worked outside the Dome"" penalty."]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000393--[[Add Specialization To All]]],
	ActionMenubar = "ECM.ECM.Colonists.Workplaces",
	ActionId = ".Add Specialization To All",
	ActionIcon = StarkFistOfRemoval,
	RolloverText = TranslationTable[302535920000394--[[If Colonist has no Specialization then add a random one]]],
	OnAction = ChoGGi.MenuFuncs.ColonistsAddSpecializationToAll,
}

c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000339--[[Toggle All Shifts]]],
	ActionMenubar = "ECM.ECM.Colonists.Workplaces",
	ActionId = ".Toggle All Shifts",
	ActionIcon = "CommonAssets/UI/Menu/AlignSel.tga",
	RolloverText = TranslationTable[302535920000340--[[Toggle all workshifts on or off (farms only get one on).]]],
	OnAction = CheatToggleAllShifts,
}

c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000341--[[Update All Workplaces]]],
	ActionMenubar = "ECM.ECM.Colonists.Workplaces",
	ActionId = ".Update All Workplaces",
	ActionIcon = "CommonAssets/UI/Menu/AlignSel.tga",
	RolloverText = TranslationTable[302535920000342--[[Updates all colonist's workplaces.]]],
	OnAction = CheatUpdateAllWorkplaces,
}

c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000343--[[Clear Forced Workplaces]]],
	ActionMenubar = "ECM.ECM.Colonists.Workplaces",
	ActionId = ".Clear Forced Workplaces",
	ActionIcon = "CommonAssets/UI/Menu/AlignSel.tga",
	RolloverText = TranslationTable[302535920000344--[["Removes ""user_forced_workplace"" from all colonists."]]],
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000397--[[Visit Fail Penalty]]],
	ActionMenubar = "ECM.ECM.Colonists.Stats",
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000399--[[Renegade Creation Toggle]]],
	ActionMenubar = "ECM.ECM.Colonists.Stats",
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920001589--[[Disable creation of renegades.]]]
				.. "\n" .. TranslationTable[302535920000400--[[Works after daily update.]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000401--[[Set Renegade Status]]],
	ActionMenubar = "ECM.ECM.Colonists.Stats",
	ActionId = ".Set Renegade Status",
	ActionIcon = StarkFistOfRemoval,
	RolloverText = TranslationTable[302535920000448--[[I'm afraid it could be 9/11 times 1, 000.]]],
	OnAction = ChoGGi.MenuFuncs.SetRenegadeStatus,
}

c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000402--[[Morale Always Max]]],
	ActionMenubar = "ECM.ECM.Colonists.Stats",
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920000403--[["Colonists always max morale (will effect birthing rates).
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000408--[[Chance Of Sanity Damage]]],
	ActionMenubar = "ECM.ECM.Colonists.Stats",
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920000409--[[Disable colonists taking sanity damage from certain events.]]]
				.. "\n" .. TranslationTable[302535920000405--[[Works after in-game hour.]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000410--[[University Grad Remove Idiot]]],
	...
	RolloverText = function()
		return SettingState(
			...
			TranslationTable[302535920000411--[[When colonist graduates this will remove idiot trait.]]]
		)
	end,
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000412--[[Chance Of Negative Trait]]],
	ActionMenubar = "ECM.ECM.Colonists.Traits",
...
c = c + 1
Actions[c] = {ActionName = TranslationTable[302535920000420--[[Positive Playground]]],
	ActionMenubar = "ECM.ECM.Colonists.Traits",

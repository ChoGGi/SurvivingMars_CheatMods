...
Cheats.Research>Outsourcing For Free: Outsourcing is free to purchase (over n over).
...
Cheats>Start Mystery: Pick and start a mystery (with instant start option).
...
ECM.Buildings.Toggles>Pipes Pillars Spacing: 1000: Only place Pillars at start and end.
...
ECM.Colonists.Stats>Chance of Suicide: Disable chance of suicide when Sanity reaches zero.
Works after colonist idle.
ECM.Colonists.Stats>Min Comfort Birth: Change the limit on birthing comfort (more/less babies).
...
ECM.Colonists.Stats>No Home Comfort Damage: Disable colonists taking comfort damage from not having a home.
Works after in-game hour.
ECM.Colonists.Stats>Renegade Creation Toggle: Disable creation of renegades.
Works after daily update.
ECM.Colonists.Stats>See Dead Sanity Damage: Disable colonists taking sanity damage from seeing dead.
Works after in-game hour.
ECM.Colonists.Stats>Set Renegade Status: I'm afraid it could be 9/11 times 1,000.
ECM.Colonists.Stats>Visit Fail Penalty: Disable comfort penalty when failing to satisfy a need via a visit.
ECM.Colonists.Traits>Chance Of Negative Trait: Disable chance of getting a negative trait when Sanity reaches zero.
Works after colonist idle.
ECM.Colonists.Traits>Positive Playground: 100% Chance to get a perk (when grown) if colonist has visited a playground as a child.
ECM.Colonists.Traits>Project Morpheus Positive Trait: 100% Chance to get positive trait when Resting and ProjectMorpheus is active.
...
ECM.Colonists.Workplaces>Colonists Avoid Fired Workplace: After being fired, Colonists won't avoid that Workplace searching for a Workplace.
Works after colonist idle.
ECM.Colonists.Workplaces>Fire All Colonists!: Fires everyone from every job.
ECM.Colonists.Workplaces>Outside Workplace Radius: Change how many hexes colonists search outside their dome when looking for a Workplace.
...
ECM.Colonists.Workplaces>Performance Penalty Connected Dome: Disable performance penalty for colonists working in another connected dome.
Activated when colonist changes job.
ECM.Colonists.Workplaces>Performance Penalty Non-Specialist: Disable performance penalty for non-Specialists.
Activated when colonist changes job.
...
ECM.Colonists>Colonists Starve: Disable colonists starving with no food.
Works after colonist idle.
ECM.Colonists>Colonists Suffocate: Disable colonists suffocating with no oxygen.
Works after in-game hour.
...
ECM.Colonists>Set Stats: Change the stats of all colonists (health/sanity/comfort/morale).
Not permanent.
...
ECM.Drones>Drone Carry Amount: Change amount drones can carry.
ECM.Drones>Drone Gravity: Change gravity of Drones.
ECM.Drones>Drone Move Speed: How fast drones will move.
ECM.Drones>Drone Repair Supply Leak Speed: Faster Drone fix supply leak.
...
ECM.Drones>Drone recharge time: Faster/Slower Drone Recharge.
ECM.Drones>DroneFactory Build Speed: Change how fast drone factories build drones.
ECM.Drones>Drones Per Drone Hub: Change amount of drones Drone Hubs will command.
ECM.Drones>Drones Per RC Rover: 25: Change amount of drones RC Rovers will command.
...
ECM.Mission.Disasters>Meteor Damage: Disable Meteor damage (colonists?).
...
ECM.Resources>Food per Rocket Passenger: Change the amount of Food supplied with each Colonist arrival.
...
ECM.Shuttles>Set Capacity: Change capacity of shuttles.
...
Game.Interface>GUI Dock Side: Right: Change which side (most) GUI menus are on.

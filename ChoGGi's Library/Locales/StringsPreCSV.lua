...
302535920000483, "Write Console Log"
302535920000484, "Write console log to <green>%slogs/ConsoleLog.log</green> (updated every 5 seconds)."
...
302535920001356, "New"
302535920001355, "Map"
302535920001354, "<green>%s</green> is a Dome with stuff still in it (crash if deleted)."
302535920000723, "Lua"
302535920001257, "Auto-refresh list every second."
302535920001288, "Wrap Lines"
302535920001289, "Wrap lines or show horizontal scrollbar."
...
302535920001303, "Search for text within <green>%s</green>."
...
302535920000834, "Max"
302535920000933, "Current speed: <green>%s</green>"
...
302535920000219, "Export viewed image to <green>%s</green>."
...
302535920001606, "Max the <green>%s</green> value for this colonist."
302535920001607, "Set a random <green>%s</green> for this colonist."
...
302535920001543, "Set collisions on <green>%s</green>. Collisions disabled: <yellow>%s</yellow>"
...
302535920000006, "Failed to save settings to <color ChoGGi_red>%s</color>: <yellow>%s</yellow>"
...
Use <green>%s</green> to enable it, or change <yellow>DisableECM</yellow> to false in <green>%s</green>.
...
302535920000041, "Add new entry to <green>%s</green> (Defaults to name/value of selected item)."
302535920000165, "or"
302535920000166, "BROKEN FUNCTION"
302535920000353, "Scripts"
302535920000793, "History"
302535920000881, "Place .lua files in <green>%s</green> to have them show up in the ""Scripts"" list, you can then use the list to execute them (you can also create sub-folders for sorting)."
...
302535920001267, "<color ChoGGi_red>%s</color> at position: <yellow>%s</yellow> was stopped."
302535920000968, "Collisions"
302535920000969, "Collisions <yellow>%s</yellow> on <green>%s</green>"
...
302535920000020, "Colour is set on <green>%s</green>."
...
<green>@</green><yellow>GetMissionSponsor</yellow> prints file name and line number of function, use <color ChoGGi_red>format_value(obj)</color> in lua code.

<green>@@</green><yellow>EntityData</yellow> prints type of obj, use <color ChoGGi_red>type(obj)</color> in lua code.

<green>%</green><yellow>""UI/Vignette.tga""</yellow> opens image in image viewer, use <color ChoGGi_red>OpenImageViewer(image)</color> in lua code.

<green>^</green><yellow>""text string""</yellow> opens text in text editor, use <color ChoGGi_red>OpenTextViewer(string)</color> in lua code.

<green>$</green><yellow>123</yellow> or <green>$</green><yellow>EffectDeposit.display_name</yellow> prints translated string, use <color ChoGGi_red>trans(obj)</color> in lua code.

<green>*r</green> <yellow>Sleep(1000) print(""sleeping"")</yellow> to wrap in a real time thread (or <green>*g</green>), use <color ChoGGi_red>CreateRealTimeThread(func)</color> in lua code..

<green>!</green><yellow>UICity.labels.TerrainDeposit[1]</yellow> move camera and select obj, use <color ChoGGi_red>ViewAndSelectObject(obj)</color> in lua code.

<green>s</green> = <yellow>SelectedObj</yellow>, <green>c()</green> = <yellow>GetTerrainCursor()</yellow>, <green>restart()</green> = <yellow>quit(""restart"")</yellow>"
...
302535920001095, "Double the charge capacity of this <green>%s</green>."
302535920001096, "Reset the charge capacity of this <green>%s</green> to default."
...
302535920001277, "Open <green>%s</green> in the Object Examiner."
302535920001053, "Fill up <green>%s</green> with fuel."
302535920000005, "Drops a new colonist in selected dome."
302535920001246, "Changes colour of <green>%s</green> back to default."
...
<green>%s</green>"
302535920001209, "Make this <green>%s</green> not need workers (performance: <yellow>%s</yellow>)."
302535920001210, "Make this <green>%s</green> need workers."
302535920001211, "Double the export storage capacity of this <green>%s</green>."
302535920001212, "Double the storage capacity of this <green>%s</green>."
302535920001213, "Reset the storage capacity of this <green>%s</green> to default."
...
302535920001220, "Change this <green>%s</green> so it doesn't need a <yellow>%s</yellow> source."
302535920001221, "Change this <green>%s</green> so it needs a <yellow>%s</yellow> source."
302535920001223, "Toggle any signs above <green>%s</green> (until state is changed)."
302535920001224, "Changes colour of <green>%s</green> to random colours (doesn't change attachments)."
...
302535920001228, "Set the stored amount of this <green>%s</green> to <yellow>0</yellow>."
...
302535920001234, "Double the amount this <green>%s</green> can hold."
302535920001236, "Double amount of reneagades this station can negate (currently: <green>%s</green>) < Reselect to update amount."
end !Skipped Line!
do !Skipped Line! [[FindValue.lua]] !Skipped Line!
...
302535920001529, "Press <green>Enter</green> to select next found text, and <green>Ctrl-Enter</green> to scroll to previous found text."
...
302535920000311, "Stop the ""<yellow>Attempt to use an undefined global</yellow>"" msgs.

The number is a count of stored msgs, <right_click> to view the list."
302535920001575, "Only show console log text when console is active (needs <green>%s</green> enabled)."
...
302535920001480, "Print (some) lua errors in the console (needs <green>%s</green> enabled)."
...
302535920001133, "Show the console log in a window."
302535920000407, "<left_click> Execute <right_click> Paste"
302535920001138, "<left_click> Execute this command in the console, <right_click> to paste code in console."
302535920001159, "Any .lua files in <green>%s</green>."
...
If it's an associative table then <yellow>o = value</yellow>."
302535920000589, "<left_click> Examine <right_click> Clipboard"
302535920000904, "<right_click> to copy <yellow>%s</yellow> to clipboard."
302535920000422, "Hex Shape"
302535920000417, "Null reference"
302535920000628, "Close the examine dialog
Hold <green>Shift</green> to close all ""grouped"" examine dialogs (any ex dlg opened from an ex dlg).
Hold <green>Ctrl</green> to close <color ChoGGi_red>all</color> ECM dialogs."
...
<yellow>Text</yellow> is what you see, <yellow>Object</yellow> is the text created from ValueToLuaCode(obj)."
302535920000046, "Dumps Text/Object to <yellow>%slogs\DumpedExamine.lua</yellow>."
302535920000047, "View Text/Object, and optionally dumps text to <yellow>%slogs\DumpedExamine.lua</yellow>."
...
302535920001563, "Set amount to <green>%s</green>."
302535920001564, "Double Number"
302535920001565, "Halve Number"
302535920001566, "Copy <green>ValueToLuaCode(value)</green> to clipboard."
...
302535920001545, "Going to <green>%s</green>"
302535920001544, "Attached to"
302535920001535, "Set Value"
302535920001539, "Change the value of <green>%s</green>."
302535920001540, "Show context menu for <green>%s</green>."
302535920001536, "Remove the ""<green>%s</green>"" key from <yellow>%s</yellow>."
...
<green>%sSource</green>
Example: <yellow>Source/Lua/_const.lua</yellow>"
...
302535920001515, "Press <green>%s</green> to execute code.
Use <green>%s</green>/<green>%s</green> to browse console history."
302535920001516, "o = examined object"
302535920001517, "Use <green>o</green> as a reference to the examined object: <yellow>IsValid(</yellow><green>o</green><yellow>)</yellow>."
...
302535920001001, "ECM: Slight issue with <green>%s</green> you may safely ignore the following error or three."
...
302535920000043, "<green>Enter</green> to scroll to next found text
<green>Ctrl-Enter</green> to scroll to previous found text
<yellow>Arrow Keys</yellow> to scroll to each end"
302535920000045, "Scrolls down one line or scrolls between text in ""<yellow>Search</yellow>""."
302535920000050, "Opens object in Object Editor."
302535920000052, "Execute code (using console for output). <green>o</green> is whatever object is opened in examiner.
...
302535920000070, "Shows list of attachments. This <green>%s</green> has <yellow>%s</yellow>.

Press <green>%s</green> to hide green markers."
end !Skipped Line!
...
302535920001436, "Update editor text with text from <green>%stempedit.lua</green>."
302535920000040, "Exec Code"
302535920000072, "Paste or type code to be executed here, <green>o</green> is the examined object (ignored when opened from Console).
...
302535920000076, "At caret position inserts: <green>o</green>"
end !Skipped Line!
...
The listitem <green>must</green> be selected for this to take effect (it's the last listitem).
...
302535920000082, "Check this for ""<yellow>All of type</yellow>"" to only apply to connected grid."
end end !Skipped Line!
do !Skipped Line! [[MonitorInfo.lua]] !Skipped Line!
302535920000085, "Auto-refresh list every ""<yellow>Amount</yellow>""."
...
302535920001116, "Select a <green>%s</green>."
302535920000138, "Value needs to be a <green>%s</green>."
302535920001338, "Reset to default."
302535920001339, "Are settings custom: <green>%s</green>"
...
302535920000113, "<green>%s</green> range is now <yellow>%s</yellow>."
...
302535920000128, "<green>%s</green> rate is now: <yellow>%s</yellow>"
...
302535920000137, "<green>%s</green> production is now: <yellow>%s</yellow>"
...
302535920000147, "Only apply to selected object instead of all <green>%s</green>."
302535920000148, "%s:
...
302535920000199, "Toggle curing all traits (use ""<yellow>Show All Traits</yellow>"" & ""<yellow>Show Full List</yellow>"" to manually set)."
...
Use with <green>%s</green> to fill up a dome with spires."
...
302535920001372, "Change the number on the end to fire that amount (ex: <green>%s25</green>)."
...
302535920000344, "Removes ""<green>user_forced_workplace</green>"" from all colonists."
...
302535920000359, "Breakthroughs From OmegaTelescope"
302535920000360, "How many breakthroughs the OmegaTelescope will unlock."
302535920000361, "Unpin All Pinned Objects"
302535920000362, "Removes all objects from the ""<green>Pin</green>"" menu."
...
302535920000261, "Reveals the map and unlocks ""<green>Deep</green>"" resources."
...
See Cheats><green>%s</green> to remove."
302535920000270, "Instant Start"
302535920000271, "May take up to one Sol to ""instantly"" activate mystery."
302535920000272, "To play back speech press the ""<green>%s</green>"" checkbox and type in
...
302535920000291, "Waiting for <green>%s</green> to finish.
...
Current Pool Size: <green>%s</green>"
...
302535920000802, "Usual age is around <green>%s</green>. This doesn't stop colonists from becoming seniors; just death (research ForeverYoung for enternal labour)."
...
302535920000849, "Will also fire workers with the traits from all <green>%s</green>."
...
302535920001555, "Choose a random <green>%s</green> to be the context for this storybit."
...
For the value enter either ""<green>true</green>"" (to use 5) or a number.
...
302535920001163, "Flatten height has been choosen <green>%s</green>, press shortcut again to update buildable."
...
302535920000852, "This will delete all <yellow>%s</yellow> of <color ChoGGi_red>%s</color>"
302535920000856, "Yes, I want to delete all: <color ChoGGi_red>%s</color>"
302535920000857, "No, I need to backup my save first (like I should've done before clicking something called ""<green>Delete All</green>"")."
302535920000859, "Anim State"
302535920000860, "Set Anim State"
302535920000861, "Current State: <green>%s</green>"
...
Use <green>%s</green> to show a list of all objects in a radius around cursor."
...
302535920000496, "Reloads particles from ""<green>Data/Particles</green>""..."
...
302535920000909, "If you set this amount larger then a building's ""<green>Storage</green>"" amount then the drones will NOT pick up storage (See: Fixes>%s)."
302535920000910, "Somewhere above 1000 will delete the save (when it's full)"
302535920000911, "Drones can carry <green>%s</green> items."
302535920000913, "Set Drone Carry Capacity"
302535920000915, "Max: 1000."
302535920000916, "DroneHubs can control <green>%s</green> drones."
302535920000918, "Set DroneHub Drone Capacity"
302535920000921, "RC Rovers can control <green>%s</green> drones."
...
302535920001191, "Added prefabs to <green>%s</green> buildings."
...
302535920000957, "<green>%s</green> capacity is now <yellow>%s</yellow>."
...
302535920000960, "<green>%s</green> visitor capacity is now <yellow>%s</yellow>."
...
Open <green>%s</green> to see all the textures, the tooltips show the texture index."
...
302535920001502, "Export map location data to <green>%sMapData.csv</green> (will take awhile).
...
302535920001219, "Export colonist data to <green>%sColonists.csv</green>."
...
302535920000974, "Map default: <green>%s</green>"
...
302535920001002, "For some reason they went opposite day with this one: <yellow>255</yellow> is invisible and <yellow>0</yellow> is visible.
Set value to <green>0</green> to remove setting."
...
302535920001507, "Uncheck to upload to Paradox mods (instead of Steam)."
...
302535920000665, "If uploading a mod this copies mod steam id or uuid to clipboard."
...
302535920001258, "Copy Files"
302535920001259, "Copies all mod files to <green>%sModUpload</green>, uncheck to copy files manually."
302535920001260, "Blank"
302535920001261, "Uploads a blank mod, and prints id in log."
302535920001262, "<green>%sModUpload</green> folder is empty and waiting for files."
...
Old settings are saved as <green>%s</green> (or not saved if you don't use the HelperMod)."
...
For any issues; please report them to my Github/Steam/NexusMods page, or email <green>%s</green>"
...
<green>Ctrl-Shift-0</green> to re-enable, or see Game options>Key bindings for the re-enable key."
...
302535920000523, "How many to multiple the default speed by: <green>%s</green>."
...
302535920001093, "Toggled: <green>%s</green> pinnable objects."
...
302535920001109, "Loops though and makes all <green>%s</green> visible."
...
302535920001134, "%s = base number <green>%s</green> multipled by custom value amount."
...
302535920001151, "Set Entity For <green>%s</green>."
...
302535920000867, "Toggle occurrence of <yellow>%s</yellow> disasters."
302535920001460, "Add/remove rival colonies."
302535920001462, "<green>%s</green> rival colonies."
302535920001247, "Start Challenge"
302535920001249, "Shows a list of challenges you can start (replaces current)."
302535920001415, "Sols to Complete: <green>%s</green>"
...
302535920001405, "Drones will now spawn as: <green>%s</green>"
...
302535920001161, "Sponsor for this save is now <green>%s</green>."
...
302535920001173, "Commander for this save is now <green>%s</green>."
302535920001178, "Set New Logo"
302535920001179, "<green>%s</green> occurrence is now: <yellow>%s</yellow>"
...
302535920000966, "Set the occurrence level of <yellow>%s</yellow> disasters."
